...
files = dir('C:\Users\WorkStation2\Documents\GitHub\EVB_data\EVB_Calibration_Analysis\900_MHz_Library\MUSIC\Result_0p915_lib_MUSIC\*.mat');
...
if save_figs
    ...
    saveas(figure(10), fullfile(newFolderPath, 'Error_MUSIC.jpeg'))

    saveas(figure(12), fullfile(newFolderPath, 'Principle_Plane_MUSIC.jpeg'))
    
    saveas(figure(13), fullfile(newFolderPath, 'Principle_Plane_Error_MUSIC.jpeg'))
end
